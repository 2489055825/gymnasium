...
<nav class="navbar navbar-default">
    ...
    <ul class="nav nav-pills nav-justified">
        ...
        <li class="active"><a href="myOrders">我的订单</a></li>
...
<div class="row">
    ...
    <div class="col-md-12">
        <legend class="text-center">我的订单</legend>

        <table class="table table-bordered table-striped">
            <tr><th>订单ID</th><th>教练名</th><th>课程名</th><th>订单详情</th><th>退订</th></tr>
            ...
            <tr>
                ...
                <td>
                    <a href="deleteOrders?ordersID=${orders.orderID}">
                        <span class="glyphicon glyphicon-minus" aria-hidden="true"></span>退订
                    </a>
                </td>
            </tr>
            </c:forEach>
